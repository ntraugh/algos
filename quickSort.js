...
const findTheSpread = (ppg, ppg2, opposingPapg, opposingPapg2) => {
    const firstTeamScore = (ppg + opposingPapg) / 2
    const secondTeamScore = (ppg2 + opposingPapg2) / 2
...
console.log(findTheSpread(28.4, 27.1, 21.9, 17))